const ToS = () => {
	return (
		<article>
			<h1>TERMS OF USE</h1>
			<p className="tos_updateTimeStamp">Last updated March 27, 2021</p>
			<h2>AGREEMENT TO TERMS</h2>
			<p>
				These Terms of Use constitute a legally binding agreement made
				between you, whether personally or on behalf of an entity
				(“you”) and Symplee.App ("Company", “we”, “us”, or “our”),
				concerning your access to and use of the https://www.symplee.app
			...
			<ul className="tos_electronicPayments">
				<li>Visa</li>
				<li>Mastercard</li>
			...
			<ul id="tos_prohibitedActivites">
				...
				<li>
					...
					securityrelated features of the Site, including features
				...
				<li>
					...
					revenuegenerating endeavor or commercial enterprise.
				</li>
				<li>
				...
				<li>
					...
					limitation, clear graphics interchange formats (“gifs”), ×1
			...
			<ul className="tos_userGeneratedContributions">
				<li>
					The creation, distribution, transmission, public display,
					or, and the accessing, downloading, or copying of your
			...
			<p>
				...
				within the State of Michigan, without regard to its conflict of
				law principles.
			</p>
			...
			<p>
				...
				take place in __________. Except as otherwise provided herein,
			...
			<p>
				...
				state and federal courts located in __________, and the Parties
			...
			<p>
				...
				any way to the Site be commenced more than three (3) years after
			...
			<p>
				...
				TO ANY CAUSE OF ACTION ARISING OR $120.00 USD. CERTAIN US STATE
			...
			<div className="tos_contactUs">
				...
				<h4>Symplee.App</h4>
				<p>__________</p> <p>__________</p> <p>United States</p>
				<div>
					<h4>Phone:</h4> <p>__________</p>
				</div>
				<p>__________</p>
			</div>
		</article>
